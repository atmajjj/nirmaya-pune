/// Default Metal Definitions for HPI Calculator
/// 
/// Contains BIS (Bureau of Indian Standards) and WHO (World Health Organization)
/// standard values for heavy metals commonly analyzed in water quality assessment.
...
const List<MetalDefinition> DEFAULT_METALS = [
  ...
  MetalDefinition(
    symbol: 'Hg',
    name: 'Mercury',
    standardLimit: 2,     // Si = 2 ppb (very toxic)
