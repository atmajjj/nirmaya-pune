...
import 'hpi_calculator_core.dart';
...
void runTestCase() {
  ...
  // Note: The expected values in the specification have some rounding
  // Let's recalculate manually to verify:
  // Wi(As) = 1/(50-10) = 1/40 = 0.025
  // Wi(Cu) = 1/(1500-50) = 1/1450 = 0.000689655...
  // Wi(Zn) = 1/(15000-5000) = 1/10000 = 0.0001
  // Wi(Hg) = 1/(2-1) = 1
  // Wi(Cd) = 1/(5-3) = 0.5
  // Wi(Ni) = 1/(70-20) = 1/50 = 0.02
  // Wi(Pb) = 1/(10-0) = 0.1
  
  // Qi(As) = (|0.048-10|/40)*100 = (9.952/40)*100 = 24.88
  // Qi(Cu) = (|2.54-50|/1450)*100 = (47.46/1450)*100 = 3.273103...
  // Qi(Zn) = (|43.89-5000|/10000)*100 = (4956.11/10000)*100 = 49.5611
  // Qi(Hg) = (|2.83-1|/1)*100 = 1.83*100 = 183
  // Qi(Cd) = (|0.06-3|/2)*100 = (2.94/2)*100 = 147
  // Qi(Ni) = (|0.095-20|/50)*100 = (19.905/50)*100 = 39.81
  // Qi(Pb) = (|0.215-0|/10)*100 = 0.215*10 = 2.15
}
...
void exampleHPICalculation() {
  ...
  final result = HPICalculator.calculateHPIWithDetails(DEFAULT_METALS, sample);
